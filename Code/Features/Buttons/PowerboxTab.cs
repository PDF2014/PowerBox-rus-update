...
namespace PowerBox.Code.Features.Buttons {
  ...
  public class PowerboxTab : ModPowerTabFeature {
    ...
    protected override PowersTab InitObject() {
      ...
      PowerButtonCreator.CreateSimpleButton("powerbox_metas_section_button", () => SwitchSection(TabSection.Metas), AssetUtils.LoadEmbeddedSprite("ui/meta_section"), tab.transform);
